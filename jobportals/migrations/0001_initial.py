...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('degree_level', models.CharField(choices=[('DI', 'Diploma'), ('BA', 'Bachelor'), ('MA', 'Master'), ('DO', 'Doctoral'), ('N', 'Does not matter')], max_length=2)),
                ...
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employee_educationalbackground', to='jobportals.employee')),
                ('employer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employer_educationalbackground', to='jobportals.employer')),
            ],
        ),
        migrations.AddField(
            model_name='city',
